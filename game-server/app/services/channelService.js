 ...
 */
ChannelService.prototype.add = function(uid, playerName, channelName) {
 ...
 * @param  {String} channelName channel name
 */
ChannelService.prototype.leave = function(uid, channelName) {
 ...
 * @param  {String} uid user id
 */
ChannelService.prototype.kick = function(uid) {
 ...
 */
ChannelService.prototype.pushByChannel = function(channelName, msg, cb) {
 ...
 */
ChannelService.prototype.pushByPlayerName = function(playerName, msg, cb) {
