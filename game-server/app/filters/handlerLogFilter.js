...
Filter.prototype.after = function(err, msg, session, resp, next) {
    ...
    console.log(this.app.serverType);
    var code = (resp === undefined) ? undefined : resp.code
    var log = {
      route: msg.__route__,
      req: msg,
      res: resp,
      remote: this.app.sessionService ? this.app.sessionService.getClientAddressBySessionId(session.id) : '',
      timeUsed: timeUsed,
      code: code
    }
